...
/**
 * Tämä luokka laajentaa Moottori-luokkaa vastaamaan paremmin simulaation tarpeita
 * 
...
public class OmaMoottori extends Moottori{
	...
	/**
	 * Alustaa kaikki arvot alkuarvoiksi
	 * jos käyttäjä haluaa käynnistää simulaation uudestaan ilman
	 * ohjelman sulkemista
	 * 
	 */
	@Override
	...
	/**
	 *Tarkistaa ensin onko tapahtuma saapuminen:
	 *Jos on, se luo samalla seuraavan saapumisen
	 *Jos ei, se poistaa tapahtuman listasta, asiakkaan systeemistä
	 *ja tallentaa tulokset
	 */
	@Override
	...
	/**
	 *Asettaa vähintään yhden työntekijän per palvelupiste
	 */
	...
	/**
	 *Asettaa palvelutiskin ja vähintään yhden korjaamopisteen
 	 */
	...
	/**
	 *Asettaa asiakasmäärän tunnissa (väh. 3)
	 */
	...
	/**
	 * Tallentaa tiedot päivän vaihtuessa
	 */
	...
	/**
	 * Tallentaa tulokset tietokantaan ja tulostaa konsoliin
	 * Pysäyttää lopuksi simulaation
	 */
	@Override
